...
C             + number of mass constraints
      ...
      PARAMETER (MAXVTX = CCTVMFT_MAXVTX)  ! Maximum number of vertices
      PARAMETER (MAXTRK = CCTVMFT_MAXTRK)  ! Maximum number of tracks
      PARAMETER (MAXMCN = CCTVMFT_MAXMCN)  ! Maximum number of mass constraints
      PARAMETER (MAXDIM = 5*(MAXVTX+1) + 3*MAXTRK + MAXMCN)

C Parameters important to the procedure
      INTEGER    MAXITR
      PARAMETER (MAXITR = CCTVMFT_MAXITR)  ! Maximum number of iterations
C
      INTEGER    UDIM
